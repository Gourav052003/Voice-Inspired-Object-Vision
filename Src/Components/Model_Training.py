...
class ModelTraining:
    ...
    def train_model(self):
        ...
        # model_history = model.fit(x = self.X, y = self.Y, epochs = self.EPOCHS, batch_size = self.BATCH_SIZE,
        #             validation_data = (self.VAL_X,self.VAL_Y), validation_batch_size = self.VALIDATION_BATCH_SIZE,
